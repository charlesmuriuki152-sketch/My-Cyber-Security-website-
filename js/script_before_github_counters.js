...
window.addEventListener("load", () => {
    ...
    animateCounter("pythonCount", dashboardData.pythonCount);
    animateCounter("linuxCount", dashboardData.linuxCount);
    animateCounter("networkCount", dashboardData.networkCount);
    animateCounter("certCount", dashboardData.certCount);
    animateCounter("projectCount", dashboardData.projectCount);
    animateCounter("securityCount", dashboardData.securityCount);
